...
import com.space.game.utilities.ISubject;
import com.space.game.utilities.InvalidParamException;

public class GameController implements ISubject {
	...
	public static GameController getInstance() throws InvalidParamException {
		if (instance == null) {
	...
	private GameController() throws InvalidParamException {
		initializeSprites();
		resetGame();
	}
